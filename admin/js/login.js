$(document).ready(function(){
	$error_result = $('<center><label class = "text-danger">Username Atau Password Salah</label></center>');
	$error_result2 = $('<center><label class = "text-danger">Tolong Lengkapi Bagian Ini</label></center>');
