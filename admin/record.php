...
<html lang = "eng">
	<head>
		<title>RECORD - SISTEM BUKU TAMU PERNIKAHAN</title>
		<meta charset = "utf-8" />
		...
		<nav class = "navbar navbar-inverse navbar-fixed-top">
			<div class = "container-fluid">
				<div class = "navbar-header">
					<p class = "navbar-text pull-right"><b>RECORD - SISTEM BUKU TAMU PERNIKAHAN</p>
				</div>
				...
				<div class = "modal-dialog" role = "document">
					<div class = "modal-content ">
						<div class = "modal-body">
							<center><label class = "text-danger">Apakah anda yakin ingin menghapus record?</label></center>
							<br />
